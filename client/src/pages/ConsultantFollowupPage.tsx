      ...
      <header className="bg-primary text-primary-foreground shadow-lg sticky top-0 z-[120] print:hidden pointer-events-auto">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-1 relative z-[130] pointer-events-auto shrink-0">
            ...
            <Button type="button" variant="outline" size="sm" onClick={() => window.location.assign(`/sheets/consultant/${initialPatientId ?? ""}`)} className="text-primary-foreground border-primary-foreground hover:bg-primary/80">الاستمارة</Button>
